...
// CONTROLLER CONTRACT
// ----------------------------------------------------------
// The controller expects this service to expose:
//
// getMilkPageData()
// saveMilkRecords()
// editMilkRecord()
...
// ==========================================================
//
// Animals that did not receive a record are automatically
// recorded as:
//
// liters: 0
// remarks: "Not Milked"
...
exports.getMilkPageData =
    async () => {
        ...
        // --------------------------------------------------
        // RECORDS DISPLAYED BY CURRENT SESSION
        // --------------------------------------------------
