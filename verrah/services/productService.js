...
async function getProduct(id) {
    ...
    // Fallback for older Product documents created before
    // directionsOfUse was stored directly on Product.
    if (
        !normalizeDirections(product.directionsOfUse) &&
        product.stock
    ) {
        ...
        product.directionsOfUse = normalizeDirections(
